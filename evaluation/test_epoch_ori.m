...
resultsdir = 'D:\Removal\data4\others\2023_ShadowFormer\SRD_fuxian\results\'; resultslist = dir([resultsdir '/*.jpg']);

% % SRD
% gtdir = 'D:\ShadowData\SRD\test\test_C\'; GTlist = dir([gtdir '/*.jpg']);
% maskdir = 'D:\ShadowData\SRD\test\test_B\'; masklist = dir([maskdir '/*.jpg']);
% resultsdir = 'D:\Removal\data4\others\2020_DSC\ASRD\'; resultslist = dir([resultsdir '/*.jpg']);


% ISTD+
% gtdir = 'D:\ShadowData\ISTD\test\test_C_fixed\'; GTlist = dir([gtdir '/*.png']);
% maskdir = 'D:\ShadowData\ISTD\test\test_B\'; masklist = dir([maskdir '/*.png']);
% resultsdir = 'D:\Removal\data4\others\2021_DC_Net\AISTD\'; resultslist = dir([resultsdir '/*.png']);
